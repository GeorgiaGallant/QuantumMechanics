 ...
 */
@Autonomous(name="CapBallShootBlue", group="RGB + Encoder")

public class capBallShootBlue extends LinearOpMode {
    ...
    DcMotor LFMotor;
        ...
        public void runOpMode() throws InterruptedException {
            ...
            encoderDrive(TURN_SPEED, 10, 10, 10, 10, 4.0);   // turn right
            LFMotor.setPower(0);
            LBMotor.setPower(0);
            RFMotor.setPower(0);
            RBMotor.setPower(0);
