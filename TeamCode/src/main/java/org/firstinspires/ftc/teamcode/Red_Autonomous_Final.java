 ...
 * Blue Autonomous
 */
@Autonomous(name="Red Autonomous FINAL", group="RGB + Encoder")

public class Red_Autonomous_Final extends LinearOpMode{
   ...
   //     telemetry.addData("STARTED", 6666);
        ...
        encoderDrive(TURN_SPEED, 4.6, 4.6, 4.6, 4.6, 4.3);



        while (colorSensorL.alpha() < 20) {
...
//        }
       ...
       encoderDrive(TURN_SPEED, -3.3, -3.3, -3.3, -3.3, 5.0);
        sleep(200);
        ...
        while(colorSensorF.alpha() < 2 ) {
            ...
            errorR = Math.abs(colorSensorL.alpha() - 25);
